...
<head>
	<meta charset="UTF-8">
	<title>Testopia | Take a Test </title>

	<link rel="stylesheet" type="text/css" href="../css/style.css">
</head>
<body>
		<header>
			<stong>Testopia | Take a Test (CS490) </stong>
							<?php 
...
$examnumber = 0;
echo "<table>";
echo "<tr><td>Status</td><td>Release Status</td><td>Test ID</td><td>Test Name</td><td>Take Test</td></tr>";

while ($examnumber < $totalexams) {
echo "<form action='../scripts/viewTakeExam.php' method='POST'>";
